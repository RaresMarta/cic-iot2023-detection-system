...
Authentication uses Supabase email/password, limited to identity verification with per-user isolation enforced by Postgres row-level security. Finally, the deployed model is the one trained offline; the demo does not adapt to feedback during a session.
