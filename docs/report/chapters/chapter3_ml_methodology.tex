...
% TODO(verify-vs-code): the text claims 10,000 inference passes per batch size,
% but config.py sets N_RUNS = 1000 (warmup 100 matches). Align the text with the
% code (or rerun the benchmark with 10k) before submission. Same claim appears in
% FR-P8 in the requirements chapter.
