...
class IDSPredictor:
    def __init__(self, models_dir: Path, split: str = 'temporal', mode: str = '2',
        ...
        # Use the exact feature columns the model was trained on (the 25-feature
        # reduced set), persisted at training time. Fall back to the full config
        # list only if the artefact is missing.
